...
const priorityColors: Record<string, string> = {
  critical: "border border-danger-500/30",
  high: "border border-warning-500/30",
  medium: "border border-primary-300",
  low: "border border-navy-200",
};

...
export default function LoginPage() {
  ...
  return (
    <AuthLayout headline={ar ? <>أهلاً بيك تاني 👋</> : <>Welcome back 👋</>}>
      <p className="animate-auth-rise mb-6 text-sm text-navy-500" style={{ animationDelay: '20ms' }}>
        {ar ? 'سجّل الدخول عشان تكمل شغلك من حيث ما وقفت.' : 'Sign in to pick up right where you left off.'}
      </p>
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <div className="animate-auth-rise" style={{ animationDelay: '130ms' }}>
